...
TEST_F(PrimaryIoManagerTest, AddMouse) {
  manager_->AddMouse("/dev/usb/3-2", "cool mouse", "1:1");
...
TEST_F(PrimaryIoManagerTest, AddKeyboard) {
  manager_->AddKeyboard("/dev/usb/3-2", "cool keyboard", "1:1");
...
TEST_F(PrimaryIoManagerTest, AddKeyboardAndMouse) {
  manager_->AddKeyboard("/dev/usb/3-2", "cool keyboard", "1:1");
  manager_->AddMouse("/dev/usb/3-1", "cool mouse", "1:2");
...
TEST_F(PrimaryIoManagerTest, AddKeyboardAndMouseSameDevice) {
  manager_->AddKeyboard("/dev/usb/3-1", "cool keyboard", "1:1");
  manager_->AddMouse("/dev/usb/3-1", "cool mouse", "1:2");
...
TEST_F(PrimaryIoManagerTest, AddAndRemoveDevices) {
  ...
  manager_->AddKeyboard(keyboard, "cool keyboard", "1:1");
  manager_->AddMouse(mouse, "cool mouse", "1:2");
...
TEST_F(PrimaryIoManagerTest, TwoMice_RemovePrimary) {
  ...
  manager_->AddMouse(primary_mouse, "cool mouse", "1:1");
  manager_->AddMouse(secondary_mouse, "cooler mouse", "1:2");
