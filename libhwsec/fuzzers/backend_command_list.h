...
using FuzzCommandList =
    CommandList<&Backend::Attestation::Quote,
                ...
                &Backend::LECredentialManager::GetDelayInSeconds,
                &Backend::LECredentialManager::GetDelaySchedule,
                &Backend::LECredentialManager::GetExpirationInSeconds,
                &Backend::LECredentialManager::GetWrongAuthAttempts,
