...
#ifndef LIBHWSEC_BACKEND_PINWEAVER_MANAGER_PERSISTENT_LOOKUP_TABLE_H_
#define LIBHWSEC_BACKEND_PINWEAVER_MANAGER_PERSISTENT_LOOKUP_TABLE_H_
...
// determine the labels required to compute the auxiliary hashes needed to
...
class PersistentLookupTable {
 public:
  explicit PersistentLookupTable(base::FilePath basedir);
...
#endif  // LIBHWSEC_BACKEND_PINWEAVER_MANAGER_PERSISTENT_LOOKUP_TABLE_H_
