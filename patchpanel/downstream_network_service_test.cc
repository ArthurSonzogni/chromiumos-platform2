...
class DownstreamNetworkServiceTest : public testing::Test {
 protected:
  void SetUp() override {
    ...
    shill_client_helper_ = std::make_unique<FakeShillClientHelper>();
    shill_client_ = shill_client_helper_->FakeClient();
    ipv6_svc_ = std::make_unique<MockGuestIPv6Service>();
    conntrack_monitor_ = std::make_unique<MockConntrackMonitor>();
    counters_svc_ = std::make_unique<MockCountersService>(
  ...
  std::unique_ptr<FakeShillClientHelper> shill_client_helper_;
  std::unique_ptr<FakeShillClient> shill_client_;
  std::unique_ptr<MockGuestIPv6Service> ipv6_svc_;
  std::unique_ptr<MockConntrackMonitor> conntrack_monitor_;
  std::unique_ptr<MockCountersService> counters_svc_;
...
TEST_F(DownstreamNetworkServiceTest,
  ...
  Mock::VerifyAndClearExpectations(forwarding_svc_.get());
