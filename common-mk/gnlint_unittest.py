...
class FilesystemUtilityTests(cros_test_lib.MockTempDirTestCase):
    ...
    def testGnFileOption(self):
        ...
        osutils.WriteFile(
            gnfile, gn_options + static_library_with_visibility_flag
        )
        ret = gnlint.CheckGnFile(gnfile)
        self.assertEqual(ret, [])
