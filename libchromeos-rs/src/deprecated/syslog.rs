...
macro_rules! log {
    ($pri:expr, $($args:tt)+) => ({
        $crate::deprecated::syslog::log($pri, $crate::deprecated::syslog::Facility::User,
                                        Some((file!(), line!())), format_args!($($args)+))
    })
}
...
#[macro_export]
macro_rules! error {
    ($($args:tt)+) => ($crate::log!($crate::deprecated::syslog::Priority::Error, $($args)*))
}
...
#[macro_export]
macro_rules! warn {
    ($($args:tt)+) => ($crate::log!($crate::deprecated::syslog::Priority::Warning, $($args)*))
}
...
#[macro_export]
macro_rules! info {
    ($($args:tt)+) => ($crate::log!($crate::deprecated::syslog::Priority::Info, $($args)*))
}
...
#[macro_export]
macro_rules! debug {
    ($($args:tt)+) => ($crate::log!($crate::deprecated::syslog::Priority::Debug, $($args)*))
}
