...
constexpr std::pair<CrashCollectionStatus, std::string_view> kStatusNames[] = {
    ...
    {CrashCollectionStatus::kDevCoredumpIgnored, "Dev coredump ignored"},
    {CrashCollectionStatus::kSuccessForConnectivityFwdump,
     "Success (for connectivity firmware dump)"},
    ...
    {CrashCollectionStatus::kFailureLoadingPstoreCrash,
     "Failure loading Pstore crash"},
    {CrashCollectionStatus::kPstoreCrashEmpty, "Pstore crash report empty"},
    {CrashCollectionStatus::kFailureGettingPstoreType,
     "Failure determining type of pstore crash"},
    ...
    {CrashCollectionStatus::kUncollectedPstoreCrashType,
     "Pstore crash found but not of a type we collect"},
    ...
    {CrashCollectionStatus::kInvalidKernelNumber, "Invalid kernel number"},
    {CrashCollectionStatus::kFailedGetDaemonStoreFbPreprocessordDirectory,
     "Failure getting daemon store directory for FbPreprocessord"},
    {CrashCollectionStatus::kFailedGetFbpreprocessorUserNameInfo,
     "Failure getting info for username fdpreprocessor"},
    {CrashCollectionStatus::kFailedGetFbpreprocessorGroupNameInfo,
     "Failure getting info for group name fbpreprocessor-user-access"},
    {CrashCollectionStatus::kOutOfFbpreprocessorCapacity,
     "No more capacity in FbPreprocessor directory"},
    {CrashCollectionStatus::kDevCoredumpDoesntExist,
     "dev coredump doesn't exist"},
