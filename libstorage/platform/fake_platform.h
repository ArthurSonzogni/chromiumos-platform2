...
#ifndef LIBSTORAGE_PLATFORM_FAKE_PLATFORM_H_
#define LIBSTORAGE_PLATFORM_FAKE_PLATFORM_H_
...
class BRILLO_EXPORT FakePlatform : public Platform {
 public:
  FakePlatform();
...
#endif  // LIBSTORAGE_PLATFORM_FAKE_PLATFORM_H_
