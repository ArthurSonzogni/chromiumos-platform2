...
#ifndef LIBSTORAGE_STORAGE_CONTAINER_LOGICAL_VOLUME_BACKING_DEVICE_H_
#define LIBSTORAGE_STORAGE_CONTAINER_LOGICAL_VOLUME_BACKING_DEVICE_H_
...
class BRILLO_EXPORT LogicalVolumeBackingDevice : public BackingDevice {
 public:
...
#endif  // LIBSTORAGE_STORAGE_CONTAINER_LOGICAL_VOLUME_BACKING_DEVICE_H_
