...
#ifndef LIBSTORAGE_STORAGE_CONTAINER_LOOPBACK_DEVICE_H_
#define LIBSTORAGE_STORAGE_CONTAINER_LOOPBACK_DEVICE_H_
...
class BRILLO_EXPORT LoopbackDevice : public BackingDevice {
 public:
...
#endif  // LIBSTORAGE_STORAGE_CONTAINER_LOOPBACK_DEVICE_H_
