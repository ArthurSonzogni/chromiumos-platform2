...
#ifndef LIBSTORAGE_STORAGE_CONTAINER_BACKING_DEVICE_H_
#define LIBSTORAGE_STORAGE_CONTAINER_BACKING_DEVICE_H_
...
#endif  // LIBSTORAGE_STORAGE_CONTAINER_BACKING_DEVICE_H_
