...
pub fn generate_module(
    ...
    let include_contents = r#"// Do not edit. This is generated by system_api/build.rs.
...
pub mod server;"#;
    ...
    for (module, source, bindings_type) in sub_modules {
        ...
        include_module(&mut client_out, module)?;
    }
    let mut server_out = File::create(server_dir.join("mod.rs")).map_err(Error::Create)?;
    for (module, source, bindings_type) in sub_modules {
        let opts = *match bindings_type {
        ...
        include_module(&mut server_out, module)?;
    }
