...
#ifndef METRICS_STRUCTURED_LIB_PERSISTENT_PROTO_INTERNAL_H_
#define METRICS_STRUCTURED_LIB_PERSISTENT_PROTO_INTERNAL_H_
...
#endif  // METRICS_STRUCTURED_LIB_PERSISTENT_PROTO_INTERNAL_H_
