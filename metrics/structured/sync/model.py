...
class Project:
    ...
    def __init__(self, elem):
        ...
        self.is_event_sequence_project = util.get_boolean_attr(
            elem, "cros_events"
        )
        ...
        if elem.find("key-rotation") is not None:
            self.key_rotation_period = util.get_text_child(
                elem, "key-rotation", Model.KEY_REGEX
            )
        ...
        return tw.dedent(
            f"""\
               ...
               {owners}
                 ...
                 <key-rotation>{self.key_rotation}</key-rotation>
                 <summary>
               {summary}
                 </summary>
