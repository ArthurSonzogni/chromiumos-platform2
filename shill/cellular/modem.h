...
class Modem {
 public:
  ...
  static void CreateInternalCellularDevice(DeviceInfo* device_info);
  ...
  static constexpr char kInternalInterface[] = "internal_device";
  static constexpr int kInternalInterfaceIndex = -2;
