...
constexpr Metrics::WiFiAdapterInfo AVLWiFiAdapters[] = {
    ...
    {0x8086, 0x54f0, 0x0274},  // IntelAX203,
    {0x8086, 0x54f0, 0x4274},  // IntelAX203,
    ...
    {0x8086, 0x51f0, 0x4090},  // IntelAX211,
    ...
    {0x8086, 0x272b, 0x00f0},  // IntelBE200,
    {0x8086, 0x272b, 0x00f4},  // IntelBE200,
    {0x8086, 0x272b, 0x40f0},  // IntelBE200,
    {0x1a56, 0x272b, 0x1173},  // IntelBE200,
    {0x1a56, 0x272b, 0x1174},  // IntelBE200,
    {0x14e4, 0x43ec,
    ...
    {0x14c3, 0x7920,
     Metrics::kWiFiStructuredMetricsErrorValue},  // MediaTekMT7920PCIE,
    {0x14c3, 0x7961,
    ...
    {0x14c3, 0x0616,
     Metrics::kWiFiStructuredMetricsErrorValue},  // MediaTekMT7922PCIE,
    {0x14c3, 0x7925,
     Metrics::kWiFiStructuredMetricsErrorValue},  // MediaTekMT7925PCIE,
    {0x14c3, 0x0717,
     Metrics::kWiFiStructuredMetricsErrorValue},  // MediaTekMT7925PCIE,
