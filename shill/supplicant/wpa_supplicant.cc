...
const char WPASupplicant::kInterfacePropertyAddress[] = "Address";
...
const char WPASupplicant::kKeyManagementWPAPSKSHA256[] = "WPA-PSK-SHA256";
...
const char WPASupplicant::kKeyManagementMethodSuffixPSKSHA256[] = "-psk-sha256";
const char WPASupplicant::kKeyManagementMethodSuiteB[] = "-suite-b";
const char WPASupplicant::kKeyManagementMethodSuffixEAPSHA256[] = "-eap-sha256";
