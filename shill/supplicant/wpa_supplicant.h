...
class WPASupplicant {
 public:
  ...
  static const char kInterfacePropertyCreate[];
  ...
  static const char kInterfacePropertyType[];
  static const char kInterfacePropertyTypeAP[];
  static const char kInterfacePropertyTypeStation[];
  ...
  static const char kInterfaceStateInterfaceDisabled[];
  ...
  static const char kKeyManagementWPAPSKSHA256[];
  ...
  static const char kKeyManagementMethodSuffixPSKSHA256[];
  static const char kKeyManagementMethodSuiteB[];
  static const char kKeyManagementMethodSuffixEAPSHA256[];
