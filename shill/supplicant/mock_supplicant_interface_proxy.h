...
class MockSupplicantInterfaceProxy : public SupplicantInterfaceProxyInterface {
 public:
  ...
  MOCK_METHOD(bool, GetMACAddress, (std::vector<uint8_t>*), (const override));
  MOCK_METHOD(bool,
              AddNetwork,
  ...
  MOCK_METHOD(bool, SignalPoll, (brillo::Any*), (override));
  MOCK_METHOD(bool, ANQPGet, (const KeyValueStore&), (override));
};
