...
#ifndef SHILL_MOJOM_URL_MOJOM_TRAITS_H_
#define SHILL_MOJOM_URL_MOJOM_TRAITS_H_
...
template <>
struct StructTraits<chromeos::connectivity::mojom::URLDataView,
                    net_base::HttpUrl> {
  ...
  static bool Read(chromeos::connectivity::mojom::URLDataView data,
                   net_base::HttpUrl* out_url) {
...
#endif  // SHILL_MOJOM_URL_MOJOM_TRAITS_H_
