...
class Network {
 public:
  ...
  std::optional<NetworkConfig> GetSavedIPConfig() const;
 ...
 private:
  ...
  // SLAAC, per-technology protocols, and the StaticIPConfig. Update dbus
  // IPConfig objects if anything changes.
  void RecalculateNetworkConfig();
  ...
  // Generated by RecalculateNetworkConfig() based on input NetworkConfigs from
  // varies sources.
