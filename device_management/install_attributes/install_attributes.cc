...
InstallAttributes::InstallAttributes(Platform* platform,
    ...
    : platform_(platform),
      ...
      default_attributes_(new cryptohome::SerializedInstallAttributes()),
...
bool InstallAttributes::GetByIndex(int index,
  ...
  const cryptohome::SerializedInstallAttributes::Attribute* const attr =
