...
#ifndef DEVICE_MANAGEMENT_INSTALL_ATTRIBUTES_LOCKBOX_H_
#define DEVICE_MANAGEMENT_INSTALL_ATTRIBUTES_LOCKBOX_H_
...
#endif  // DEVICE_MANAGEMENT_INSTALL_ATTRIBUTES_LOCKBOX_H_
