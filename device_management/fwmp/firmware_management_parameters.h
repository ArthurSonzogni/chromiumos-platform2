...
// parameters to TPM
#ifndef DEVICE_MANAGEMENT_FWMP_FIRMWARE_MANAGEMENT_PARAMETERS_H_
#define DEVICE_MANAGEMENT_FWMP_FIRMWARE_MANAGEMENT_PARAMETERS_H_
...
#endif  // DEVICE_MANAGEMENT_FWMP_FIRMWARE_MANAGEMENT_PARAMETERS_H_
