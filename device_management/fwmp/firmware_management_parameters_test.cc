...
class FirmwareManagementParametersTestBase : public ::testing::Test {
 public:
  ...
  fwmp::FirmwareManagementParameters fwmp_;
...
TEST_F(FirmwareManagementParametersTest, CreateNew) {
  ...
  EXPECT_CALL(hwsec_,
              PrepareSpace(hwsec::Space::kFirmwareManagementParameters,
                           fwmp::FirmwareManagementParameters::kNvramBytes))
...
TEST_F(FirmwareManagementParametersTest, LoadMinorVersion) {
  ...
  // Recalculate CRC
  nvram_data[0] = Crc8(
      nvram_data.data() + fwmp::FirmwareManagementParameters::kCrcDataOffset,
      nvram_data.size() - fwmp::FirmwareManagementParameters::kCrcDataOffset);
