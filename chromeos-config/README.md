...
| files | array - [files](#files) |  | False |  | True |  |
| i2c-path | string |  | False |  | False | Path to the I2C device under sysfs /sys/bus/i2c/devices/*, in format <bus>-<address>. This is required for i2c interface detachable base. Note - i2c bus numbering can shift across reboots, please have corresponding setup based on your platform to ensure consistency. By taking this as an example: '/sys/bus/i2c/devices/1-0023' The i2c-path is '1-0023'. |
...
| usb-path | string |  | False |  | False | Searches and finds the idVendor and idProduct under sysfs /sys/bus/usb/devices/* which matches the vendor-id and product-id. This is required for usb interface detachable base. By taking this as an example: '/sys/bus/usb/devices/1-1.1' The usb-path is '1-1.1'. |
...
| ec-max-calibration-accel | integer |  | False |  | False | The maximal allowed calibration offset for accelerometer (in mg) Minimum value: 0x0. Maximum value: 0xfa. |
...
| modem-type | string | ```[0-9]+``` | False |  | False | The type of modem present on the device. https://chromium.googlesource.com/chromiumos/config/+/refs/heads/main/proto/chromiumos/config/api/topology.proto |
...
| exclude-from-external-display-only-models | string |  | False |  | False | For details, see https://chromium.googlesource.com/chromiumos/platform2/+/HEAD/power_manager/ |
...
| external-display-only-models | string |  | False |  | False | For details, see https://chromium.googlesource.com/chromiumos/platform2/+/HEAD/power_manager/ |
...
| min-charging-volt | string |  | False |  | False | For details, see https://chromium.googlesource.com/chromiumos/platform2/+/HEAD/power_manager/ |
...
| suspend-without-wakeup-count | string |  | False |  | False | For details, see https://chromium.googlesource.com/chromiumos/platform2/+/HEAD/power_manager/ |
| suspend-without-wakeup-count-models | string |  | False |  | False | For details, see https://chromium.googlesource.com/chromiumos/platform2/+/HEAD/power_manager/ |
...
| thread-urgent-bursty-client | [thread-urgent-bursty-client](#thread_urgent_bursty_client) |  | False |  | False | Thread config for schedqos of each QoS state. |
