...
#ifndef ODML_ON_DEVICE_MODEL_ON_DEVICE_MODEL_FACTORY_FAKE_H_
#define ODML_ON_DEVICE_MODEL_ON_DEVICE_MODEL_FACTORY_FAKE_H_
...
class OndeviceModelFactoryFake : public OndeviceModelFactory {
 public:
  OndeviceModelFactoryFake() = default;
  ~OndeviceModelFactoryFake() override = default;
...
#endif  // ODML_ON_DEVICE_MODEL_ON_DEVICE_MODEL_FACTORY_FAKE_H_
