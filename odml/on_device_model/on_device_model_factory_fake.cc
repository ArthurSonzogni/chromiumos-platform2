...
OndeviceModelFactoryFake::CreateModel(raw_ref<MetricsLibraryInterface> metrics,
...
// static
mojom::PerformanceClass OndeviceModelFactoryFake::GetEstimatedPerformanceClass(
