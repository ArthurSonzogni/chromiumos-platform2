...
#ifndef HEARTD_DAEMON_UTILS_MOJO_SERVICE_PROVIDER_H_
#define HEARTD_DAEMON_UTILS_MOJO_SERVICE_PROVIDER_H_
...
#endif  // HEARTD_DAEMON_UTILS_MOJO_SERVICE_PROVIDER_H_
