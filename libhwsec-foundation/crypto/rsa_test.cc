...
TEST(RsaTest, CreateRSAFromNumber) {
  brillo::Blob modulus{
      0x00, 0xcc, 0xe8, 0xcf, 0xb5, 0x6e, 0x36, 0x99, 0x21, 0x7b, 0x95, 0xb9,
      0x75, 0xa6, 0x80, 0x12, 0xb0, 0x54, 0x1c, 0x62, 0x10, 0x77, 0x06, 0xbf,
      0x2c, 0xad, 0xa6, 0x5a, 0x79, 0x6a, 0x23, 0x06, 0x87, 0x2a, 0xf8, 0x37,
  ...
  brillo::Blob exponent{0x01, 0x00, 0x01};
  EXPECT_TRUE(CreateRSAFromNumber(modulus, exponent));
  EXPECT_TRUE(CreateRSAFromNumber(modulus, kWellKnownExponent));
}
