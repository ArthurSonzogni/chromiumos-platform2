...
pub const NUM_THREAD_STATES: usize = ThreadState::UrgentBurstyClient as usize + 1;
...
mod tests {
    ...
    fn test_set_process_state_change_threads() {
        ...
        ctx.set_thread_state(process_id, thread_id1, thread_state_all)
            .unwrap();
