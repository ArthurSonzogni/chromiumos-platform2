...
_INSTALLOPERATION_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REPLACE_ZSTD', index=11, number=11,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REPLACE_ZSTD_INCREASED_WINDOW', index=12, number=12,
      serialized_options=None,
      type=None),
  ],
