...
class IPreparedModel : public ::ndk::ICInterface {
 public:
  ...
  static constexpr uint32_t TRANSACTION_executeSynchronously =
      FIRST_CALL_TRANSACTION + 0;
  static constexpr uint32_t TRANSACTION_executeFenced =
      FIRST_CALL_TRANSACTION + 1;
  static constexpr uint32_t TRANSACTION_configureExecutionBurst =
      FIRST_CALL_TRANSACTION + 2;
  static constexpr uint32_t TRANSACTION_createReusableExecution =
      FIRST_CALL_TRANSACTION + 3;
  static constexpr uint32_t TRANSACTION_executeSynchronouslyWithConfig =
      FIRST_CALL_TRANSACTION + 4;
  static constexpr uint32_t TRANSACTION_executeFencedWithConfig =
      FIRST_CALL_TRANSACTION + 5;

  static std::shared_ptr<IPreparedModel> fromBinder(
  ...
  virtual ::ndk::ScopedAStatus executeSynchronously(
      ...
      ::aidl::android::hardware::neuralnetworks::ExecutionResult*
          _aidl_return) = 0;
  virtual ::ndk::ScopedAStatus executeFenced(
      const ::aidl::android::hardware::neuralnetworks::Request& in_request,
...
class IPreparedModelDefault : public IPreparedModel {
 public:
  ...
  ::ndk::ScopedAStatus configureExecutionBurst(
      std::shared_ptr<::aidl::android::hardware::neuralnetworks::IBurst>*
          _aidl_return) override;
