...
class IPreparedModelDelegator : public BnPreparedModel {
 public:
  explicit IPreparedModelDelegator(const std::shared_ptr<IPreparedModel>& impl)
      : _impl(impl) {
    int32_t _impl_ver = 0;
  ...
  ::ndk::ScopedAStatus executeSynchronously(
      ...
      override {
    return _impl->executeSynchronously(in_request, in_measureTiming,
                                       in_deadlineNs, in_loopTimeoutDurationNs,
                                       _aidl_return);
  }
  ::ndk::ScopedAStatus executeFenced(
    ...
    return _impl->executeFenced(in_request, in_waitFor, in_measureTiming,
                                in_deadlineNs, in_loopTimeoutDurationNs,
                                in_durationNs, _aidl_return);
  }
  ...
  ::ndk::ScopedAStatus executeSynchronouslyWithConfig(
      ...
      ::aidl::android::hardware::neuralnetworks::ExecutionResult* _aidl_return)
      override {
    return _impl->executeSynchronouslyWithConfig(in_request, in_config,
  ...
  ::ndk::ScopedAStatus executeFencedWithConfig(
      ...
      ::aidl::android::hardware::neuralnetworks::FencedExecutionResult*
          _aidl_return) override {
    return _impl->executeFencedWithConfig(in_request, in_waitFor, in_config,
                                          in_deadlineNs, in_durationNs,
                                          _aidl_return);
  }
