...
class ExecutionConfig {
 public:
  ...
  std::vector<::aidl::android::hardware::neuralnetworks::TokenValuePair>
      executionHints;
  ...
  inline bool operator!=(const ExecutionConfig& rhs) const {
    return std::tie(measureTiming, loopTimeoutDurationNs, executionHints,
                    extensionNameToPrefix) !=
           std::tie(rhs.measureTiming, rhs.loopTimeoutDurationNs,
                    rhs.executionHints, rhs.extensionNameToPrefix);
  }
  inline bool operator<(const ExecutionConfig& rhs) const {
    return std::tie(measureTiming, loopTimeoutDurationNs, executionHints,
                    extensionNameToPrefix) <
  ...
  inline std::string toString() const {
    ...
    os << ", loopTimeoutDurationNs: "
       << ::android::internal::ToString(loopTimeoutDurationNs);
