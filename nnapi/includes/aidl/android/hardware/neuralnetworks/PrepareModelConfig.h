...
class PrepareModelConfig {
 public:
  ...
  ::aidl::android::hardware::neuralnetworks::ExecutionPreference preference =
      ::aidl::android::hardware::neuralnetworks::ExecutionPreference(0);
  ::aidl::android::hardware::neuralnetworks::Priority priority =
      ::aidl::android::hardware::neuralnetworks::Priority(0);
  ...
  inline bool operator!=(const PrepareModelConfig& rhs) const {
    return std::tie(preference, priority, deadlineNs, modelCache, dataCache,
                    cacheToken, compilationHints, extensionNameToPrefix) !=
           std::tie(rhs.preference, rhs.priority, rhs.deadlineNs,
                    rhs.modelCache, rhs.dataCache, rhs.cacheToken,
                    rhs.compilationHints, rhs.extensionNameToPrefix);
  }
  inline bool operator<(const PrepareModelConfig& rhs) const {
    return std::tie(preference, priority, deadlineNs, modelCache, dataCache,
                    cacheToken, compilationHints, extensionNameToPrefix) <
  ...
  inline std::string toString() const {
    ...
    os << ", compilationHints: "
       << ::android::internal::ToString(compilationHints);
