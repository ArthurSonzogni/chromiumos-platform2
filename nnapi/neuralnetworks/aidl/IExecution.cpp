...
_aidl_android_hardware_neuralnetworks_IExecution_onTransact(
  ...
  std::shared_ptr<BnExecution> _aidl_impl =
      std::static_pointer_cast<BnExecution>(
  ...
  switch (_aidl_code) {
    case (FIRST_CALL_TRANSACTION + 0 /*executeSynchronously*/): {
      ...
      ::ndk::ScopedAStatus _aidl_status =
          _aidl_impl->executeSynchronously(in_deadlineNs, &_aidl_return);
      _aidl_ret_status =
    ...
    case (FIRST_CALL_TRANSACTION + 1 /*executeFenced*/): {
      ...
      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->executeFenced(
          in_waitFor, in_deadlineNs, in_durationNs, &_aidl_return);
      _aidl_ret_status =
          AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) {
        break;
...
static AIBinder_Class*
    _g_aidl_android_hardware_neuralnetworks_IExecution_clazz =
        ::ndk::ICInterface::defineClass(
            IExecution::descriptor,
            _aidl_android_hardware_neuralnetworks_IExecution_onTransact);

BpExecution::BpExecution(const ::ndk::SpAIBinder& binder)
    : BpCInterface(binder) {}
BpExecution::~BpExecution() {}

::ndk::ScopedAStatus BpExecution::executeSynchronously(
    int64_t in_deadlineNs,
    ::aidl::android::hardware::neuralnetworks::ExecutionResult* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IExecution::getDefaultImpl()) {
    _aidl_status = IExecution::getDefaultImpl()->executeSynchronously(
        in_deadlineNs, _aidl_return);
...
::ndk::ScopedAStatus BpExecution::executeFenced(
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IExecution::getDefaultImpl()) {
    _aidl_status = IExecution::getDefaultImpl()->executeFenced(
        in_waitFor, in_deadlineNs, in_durationNs, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) {
...
::ndk::ScopedAStatus BpExecution::getInterfaceVersion(int32_t* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IExecution::getDefaultImpl()) {
    _aidl_status =
        IExecution::getDefaultImpl()->getInterfaceVersion(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) {
    goto _aidl_error;
...
::ndk::SpAIBinder BnExecution::createBinder() {
  AIBinder* binder =
      AIBinder_new(_g_aidl_android_hardware_neuralnetworks_IExecution_clazz,
...
const char* IExecution::descriptor =
    "android.hardware.neuralnetworks.IExecution";
IExecution::IExecution() {}
IExecution::~IExecution() {}

std::shared_ptr<IExecution> IExecution::fromBinder(
...
binder_status_t IExecution::writeToParcel(
    AParcel* parcel, const std::shared_ptr<IExecution>& instance) {
  return AParcel_writeStrongBinder(
      parcel, instance ? instance->asBinder().get() : nullptr);
}
binder_status_t IExecution::readFromParcel(
    const AParcel* parcel, std::shared_ptr<IExecution>* instance) {
...
::ndk::ScopedAStatus IExecutionDefault::executeSynchronously(
    int64_t /*in_deadlineNs*/,
...
::ndk::ScopedAStatus IExecutionDefault::executeFenced(
    const std::vector<::ndk::ScopedFileDescriptor>& /*in_waitFor*/,
    int64_t /*in_deadlineNs*/,
    int64_t /*in_durationNs*/,
    ::aidl::android::hardware::neuralnetworks::
...
::ndk::ScopedAStatus IExecutionDefault::getInterfaceVersion(
    int32_t* _aidl_return) {
  *_aidl_return = 0;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
::ndk::ScopedAStatus IExecutionDefault::getInterfaceHash(
    std::string* _aidl_return) {
  *_aidl_return = "";
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
