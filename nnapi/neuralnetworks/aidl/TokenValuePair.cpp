...
const char* TokenValuePair::descriptor =
    "android.hardware.neuralnetworks.TokenValuePair";

binder_status_t TokenValuePair::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &token);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }
...
binder_status_t TokenValuePair::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, token);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }
