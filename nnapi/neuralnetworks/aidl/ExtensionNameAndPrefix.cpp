...
const char* ExtensionNameAndPrefix::descriptor =
    "android.hardware.neuralnetworks.ExtensionNameAndPrefix";

binder_status_t ExtensionNameAndPrefix::readFromParcel(
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &prefix);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }
...
binder_status_t ExtensionNameAndPrefix::writeToParcel(
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, prefix);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }
