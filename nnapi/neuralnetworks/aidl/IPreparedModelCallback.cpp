...
_aidl_android_hardware_neuralnetworks_IPreparedModelCallback_onTransact(
  ...
  std::shared_ptr<BnPreparedModelCallback> _aidl_impl =
      std::static_pointer_cast<BnPreparedModelCallback>(
  ...
  switch (_aidl_code) {
    case (FIRST_CALL_TRANSACTION + 0 /*notify*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_preparedModel);
      if (_aidl_ret_status != STATUS_OK) {
        break;
      }

      ::ndk::ScopedAStatus _aidl_status =
          _aidl_impl->notify(in_status, in_preparedModel);
      _aidl_ret_status =
...
static AIBinder_Class*
    _g_aidl_android_hardware_neuralnetworks_IPreparedModelCallback_clazz =
        ::ndk::ICInterface::defineClass(
            IPreparedModelCallback::descriptor,
            _aidl_android_hardware_neuralnetworks_IPreparedModelCallback_onTransact);
...
::ndk::ScopedAStatus BpPreparedModelCallback::notify(
    ::aidl::android::hardware::neuralnetworks::ErrorStatus in_status,
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_preparedModel);
  if (_aidl_ret_status != STATUS_OK) {
    goto _aidl_error;
  }
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IPreparedModelCallback::getDefaultImpl()) {
    _aidl_status = IPreparedModelCallback::getDefaultImpl()->notify(
        in_status, in_preparedModel);
...
::ndk::ScopedAStatus BpPreparedModelCallback::getInterfaceVersion(
    int32_t* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IPreparedModelCallback::getDefaultImpl()) {
    _aidl_status =
        IPreparedModelCallback::getDefaultImpl()->getInterfaceVersion(
            _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) {
...
::ndk::ScopedAStatus BpPreparedModelCallback::getInterfaceHash(
    std::string* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IPreparedModelCallback::getDefaultImpl()) {
    _aidl_status = IPreparedModelCallback::getDefaultImpl()->getInterfaceHash(
        _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) {
...
::ndk::ScopedAStatus BnPreparedModelCallback::getInterfaceVersion(
    int32_t* _aidl_return) {
  *_aidl_return = IPreparedModelCallback::version;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
::ndk::ScopedAStatus BnPreparedModelCallback::getInterfaceHash(
    std::string* _aidl_return) {
...
const char* IPreparedModelCallback::descriptor =
    "android.hardware.neuralnetworks.IPreparedModelCallback";
IPreparedModelCallback::IPreparedModelCallback() {}
IPreparedModelCallback::~IPreparedModelCallback() {}

std::shared_ptr<IPreparedModelCallback> IPreparedModelCallback::fromBinder(
    const ::ndk::SpAIBinder& binder) {
...
binder_status_t IPreparedModelCallback::writeToParcel(
...
binder_status_t IPreparedModelCallback::readFromParcel(
...
bool IPreparedModelCallback::setDefaultImpl(
...
const std::shared_ptr<IPreparedModelCallback>&
IPreparedModelCallback::getDefaultImpl() {
  return IPreparedModelCallback::default_impl;
}
std::shared_ptr<IPreparedModelCallback> IPreparedModelCallback::default_impl =
    nullptr;
::ndk::ScopedAStatus IPreparedModelCallbackDefault::notify(
    ::aidl::android::hardware::neuralnetworks::ErrorStatus /*in_status*/,
    const std::shared_ptr<::aidl::android::hardware::neuralnetworks::
                              IPreparedModel>& /*in_preparedModel*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IPreparedModelCallbackDefault::getInterfaceVersion(
    int32_t* _aidl_return) {
  *_aidl_return = 0;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
::ndk::ScopedAStatus IPreparedModelCallbackDefault::getInterfaceHash(
    std::string* _aidl_return) {
  *_aidl_return = "";
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
