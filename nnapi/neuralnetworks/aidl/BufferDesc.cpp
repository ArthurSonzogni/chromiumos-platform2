...
const char* BufferDesc::descriptor =
    "android.hardware.neuralnetworks.BufferDesc";

binder_status_t BufferDesc::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t BufferDesc::writeToParcel(AParcel* _aidl_parcel) const {
