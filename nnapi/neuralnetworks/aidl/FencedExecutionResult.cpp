...
const char* FencedExecutionResult::descriptor =
    "android.hardware.neuralnetworks.FencedExecutionResult";

binder_status_t FencedExecutionResult::readFromParcel(
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &callback);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }
  ...
  _aidl_ret_status = ::ndk::AParcel_readNullableData(_aidl_parcel, &syncFence);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }
...
binder_status_t FencedExecutionResult::writeToParcel(
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, callback);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }

  _aidl_ret_status = ::ndk::AParcel_writeNullableData(_aidl_parcel, syncFence);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }
