...
const char* DataLocation::descriptor =
    "android.hardware.neuralnetworks.DataLocation";

binder_status_t DataLocation::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &poolIndex);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &padding);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }
...
binder_status_t DataLocation::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, poolIndex);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, padding);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }
