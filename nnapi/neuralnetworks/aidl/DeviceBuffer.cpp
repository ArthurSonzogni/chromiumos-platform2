...
const char* DeviceBuffer::descriptor =
    "android.hardware.neuralnetworks.DeviceBuffer";

binder_status_t DeviceBuffer::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t DeviceBuffer::writeToParcel(AParcel* _aidl_parcel) const {
