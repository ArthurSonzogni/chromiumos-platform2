...
const char* Operation::descriptor = "android.hardware.neuralnetworks.Operation";

binder_status_t Operation::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t Operation::writeToParcel(AParcel* _aidl_parcel) const {
