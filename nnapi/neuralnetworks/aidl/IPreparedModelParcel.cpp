...
const char* IPreparedModelParcel::descriptor =
    "android.hardware.neuralnetworks.IPreparedModelParcel";

binder_status_t IPreparedModelParcel::readFromParcel(
...
binder_status_t IPreparedModelParcel::writeToParcel(
