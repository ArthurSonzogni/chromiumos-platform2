...
binder_status_t Memory::writeToParcel(AParcel* _parcel) const {
  ...
  switch (getTag()) {
    case ashmem:
      return ::ndk::AParcel_writeData(_parcel, get<ashmem>());
    case mappableFile:
      return ::ndk::AParcel_writeData(_parcel, get<mappableFile>());
    case hardwareBuffer:
      return ::ndk::AParcel_writeData(_parcel, get<hardwareBuffer>());
  }
