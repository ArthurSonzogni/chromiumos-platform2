...
_aidl_android_hardware_neuralnetworks_IPreparedModel_onTransact(
  ...
  std::shared_ptr<BnPreparedModel> _aidl_impl =
      std::static_pointer_cast<BnPreparedModel>(
  ...
  switch (_aidl_code) {
    case (FIRST_CALL_TRANSACTION + 0 /*executeSynchronously*/): {
      ...
      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->executeSynchronously(
          in_request, in_measureTiming, in_deadlineNs, in_loopTimeoutDurationNs,
          &_aidl_return);
      _aidl_ret_status =
    ...
    case (FIRST_CALL_TRANSACTION + 1 /*executeFenced*/): {
      ...
      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->executeFenced(
          in_request, in_waitFor, in_measureTiming, in_deadlineNs,
          in_loopTimeoutDurationNs, in_durationNs, &_aidl_return);
      _aidl_ret_status =
          AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) {
        break;
    ...
    case (FIRST_CALL_TRANSACTION + 2 /*configureExecutionBurst*/): {
      std::shared_ptr<::aidl::android::hardware::neuralnetworks::IBurst>
          _aidl_return;

      ::ndk::ScopedAStatus _aidl_status =
          _aidl_impl->configureExecutionBurst(&_aidl_return);
      _aidl_ret_status =
          AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) {
        break;
    ...
    case (FIRST_CALL_TRANSACTION + 3 /*createReusableExecution*/): {
      ::aidl::android::hardware::neuralnetworks::Request in_request;
      ::aidl::android::hardware::neuralnetworks::ExecutionConfig in_config;
      std::shared_ptr<::aidl::android::hardware::neuralnetworks::IExecution>
          _aidl_return;
      ...
      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->createReusableExecution(
          in_request, in_config, &_aidl_return);
      _aidl_ret_status =
          AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) {
        break;
    ...
    case (FIRST_CALL_TRANSACTION + 4 /*executeSynchronouslyWithConfig*/): {
      ::aidl::android::hardware::neuralnetworks::Request in_request;
      ::aidl::android::hardware::neuralnetworks::ExecutionConfig in_config;
      int64_t in_deadlineNs;
      ::aidl::android::hardware::neuralnetworks::ExecutionResult _aidl_return;
      ...
      ::ndk::ScopedAStatus _aidl_status =
          _aidl_impl->executeSynchronouslyWithConfig(
              in_request, in_config, in_deadlineNs, &_aidl_return);
      _aidl_ret_status =
          AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) {
        break;
    ...
    case (FIRST_CALL_TRANSACTION + 5 /*executeFencedWithConfig*/): {
      ::aidl::android::hardware::neuralnetworks::Request in_request;
      std::vector<::ndk::ScopedFileDescriptor> in_waitFor;
      ::aidl::android::hardware::neuralnetworks::ExecutionConfig in_config;
      int64_t in_deadlineNs;
      ...
      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->executeFencedWithConfig(
          in_request, in_waitFor, in_config, in_deadlineNs, in_durationNs,
          &_aidl_return);
      _aidl_ret_status =
          AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) {
...
static AIBinder_Class*
    _g_aidl_android_hardware_neuralnetworks_IPreparedModel_clazz =
        ::ndk::ICInterface::defineClass(
            IPreparedModel::descriptor,
            _aidl_android_hardware_neuralnetworks_IPreparedModel_onTransact);

BpPreparedModel::BpPreparedModel(const ::ndk::SpAIBinder& binder)
    : BpCInterface(binder) {}
BpPreparedModel::~BpPreparedModel() {}

::ndk::ScopedAStatus BpPreparedModel::executeSynchronously(
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IPreparedModel::getDefaultImpl()) {
    _aidl_status = IPreparedModel::getDefaultImpl()->executeSynchronously(
        in_request, in_measureTiming, in_deadlineNs, in_loopTimeoutDurationNs,
        _aidl_return);
...
::ndk::ScopedAStatus BpPreparedModel::executeFenced(
    const ::aidl::android::hardware::neuralnetworks::Request& in_request,
  ...
  _aidl_ret_status = AIBinder_transact(
      asBinder().get(), (FIRST_CALL_TRANSACTION + 1 /*executeFenced*/),
      _aidl_in.getR(), _aidl_out.getR(),
      0
#ifdef BINDER_STABILITY_SUPPORT
          | FLAG_PRIVATE_LOCAL
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IPreparedModel::getDefaultImpl()) {
    _aidl_status = IPreparedModel::getDefaultImpl()->executeFenced(
        in_request, in_waitFor, in_measureTiming, in_deadlineNs,
        in_loopTimeoutDurationNs, in_durationNs, _aidl_return);
    goto _aidl_status_return;
  }
...
::ndk::ScopedAStatus BpPreparedModel::configureExecutionBurst(
    std::shared_ptr<::aidl::android::hardware::neuralnetworks::IBurst>*
        _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ...
  _aidl_ret_status = AIBinder_transact(
      asBinder().get(),
      (FIRST_CALL_TRANSACTION + 2 /*configureExecutionBurst*/), _aidl_in.getR(),
      _aidl_out.getR(),
      0
#ifdef BINDER_STABILITY_SUPPORT
          | FLAG_PRIVATE_LOCAL
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IPreparedModel::getDefaultImpl()) {
    _aidl_status =
        IPreparedModel::getDefaultImpl()->configureExecutionBurst(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) {
    goto _aidl_error;
...
::ndk::ScopedAStatus BpPreparedModel::createReusableExecution(
    const ::aidl::android::hardware::neuralnetworks::Request& in_request,
  ...
  _aidl_ret_status = AIBinder_transact(
      asBinder().get(),
      (FIRST_CALL_TRANSACTION + 3 /*createReusableExecution*/), _aidl_in.getR(),
      _aidl_out.getR(),
      0
#ifdef BINDER_STABILITY_SUPPORT
          | FLAG_PRIVATE_LOCAL
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IPreparedModel::getDefaultImpl()) {
    _aidl_status = IPreparedModel::getDefaultImpl()->createReusableExecution(
        in_request, in_config, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) {
...
::ndk::ScopedAStatus BpPreparedModel::executeSynchronouslyWithConfig(
    const ::aidl::android::hardware::neuralnetworks::Request& in_request,
    const ::aidl::android::hardware::neuralnetworks::ExecutionConfig& in_config,
    int64_t in_deadlineNs,
    ::aidl::android::hardware::neuralnetworks::ExecutionResult* _aidl_return) {
  ...
  _aidl_ret_status = AIBinder_transact(
      asBinder().get(),
      (FIRST_CALL_TRANSACTION + 4 /*executeSynchronouslyWithConfig*/),
      _aidl_in.getR(), _aidl_out.getR(),
      0
#ifdef BINDER_STABILITY_SUPPORT
          | FLAG_PRIVATE_LOCAL
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IPreparedModel::getDefaultImpl()) {
    _aidl_status =
        IPreparedModel::getDefaultImpl()->executeSynchronouslyWithConfig(
            in_request, in_config, in_deadlineNs, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) {
...
::ndk::ScopedAStatus BpPreparedModel::executeFencedWithConfig(
    const ::aidl::android::hardware::neuralnetworks::Request& in_request,
    const std::vector<::ndk::ScopedFileDescriptor>& in_waitFor,
    const ::aidl::android::hardware::neuralnetworks::ExecutionConfig& in_config,
    int64_t in_deadlineNs,
  ...
  _aidl_ret_status = AIBinder_transact(
      asBinder().get(),
      (FIRST_CALL_TRANSACTION + 5 /*executeFencedWithConfig*/), _aidl_in.getR(),
      _aidl_out.getR(),
      0
#ifdef BINDER_STABILITY_SUPPORT
          | FLAG_PRIVATE_LOCAL
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IPreparedModel::getDefaultImpl()) {
    _aidl_status = IPreparedModel::getDefaultImpl()->executeFencedWithConfig(
        in_request, in_waitFor, in_config, in_deadlineNs, in_durationNs,
        _aidl_return);
    goto _aidl_status_return;
  }
...
::ndk::ScopedAStatus BpPreparedModel::getInterfaceVersion(
    int32_t* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IPreparedModel::getDefaultImpl()) {
    _aidl_status =
        IPreparedModel::getDefaultImpl()->getInterfaceVersion(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) {
    goto _aidl_error;
...
::ndk::ScopedAStatus BpPreparedModel::getInterfaceHash(
    std::string* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IPreparedModel::getDefaultImpl()) {
    _aidl_status =
        IPreparedModel::getDefaultImpl()->getInterfaceHash(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) {
    goto _aidl_error;
...
::ndk::SpAIBinder BnPreparedModel::createBinder() {
  AIBinder* binder =
      AIBinder_new(_g_aidl_android_hardware_neuralnetworks_IPreparedModel_clazz,
...
::ndk::ScopedAStatus BnPreparedModel::getInterfaceVersion(
    int32_t* _aidl_return) {
  *_aidl_return = IPreparedModel::version;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
::ndk::ScopedAStatus BnPreparedModel::getInterfaceHash(
    std::string* _aidl_return) {
...
const char* IPreparedModel::descriptor =
    "android.hardware.neuralnetworks.IPreparedModel";
IPreparedModel::IPreparedModel() {}
IPreparedModel::~IPreparedModel() {}

std::shared_ptr<IPreparedModel> IPreparedModel::fromBinder(
...
binder_status_t IPreparedModel::writeToParcel(
    AParcel* parcel, const std::shared_ptr<IPreparedModel>& instance) {
  return AParcel_writeStrongBinder(
      parcel, instance ? instance->asBinder().get() : nullptr);
}
binder_status_t IPreparedModel::readFromParcel(
    const AParcel* parcel, std::shared_ptr<IPreparedModel>* instance) {
...
bool IPreparedModel::setDefaultImpl(
    const std::shared_ptr<IPreparedModel>& impl) {
...
::ndk::ScopedAStatus IPreparedModelDefault::executeSynchronously(
    const ::aidl::android::hardware::neuralnetworks::Request& /*in_request*/,
    bool /*in_measureTiming*/,
    int64_t /*in_deadlineNs*/,
    int64_t /*in_loopTimeoutDurationNs*/,
...
::ndk::ScopedAStatus IPreparedModelDefault::executeFenced(
    const ::aidl::android::hardware::neuralnetworks::Request& /*in_request*/,
    const std::vector<::ndk::ScopedFileDescriptor>& /*in_waitFor*/,
    bool /*in_measureTiming*/,
    int64_t /*in_deadlineNs*/,
    ...
    int64_t /*in_durationNs*/,
    ::aidl::android::hardware::neuralnetworks::
        FencedExecutionResult* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IPreparedModelDefault::configureExecutionBurst(
    std::shared_ptr<
        ::aidl::android::hardware::neuralnetworks::IBurst>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IPreparedModelDefault::createReusableExecution(
    const ::aidl::android::hardware::neuralnetworks::Request& /*in_request*/,
    const ::aidl::android::hardware::neuralnetworks::
        ExecutionConfig& /*in_config*/,
    std::shared_ptr<::aidl::android::hardware::neuralnetworks::
                        IExecution>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IPreparedModelDefault::executeSynchronouslyWithConfig(
    const ::aidl::android::hardware::neuralnetworks::Request& /*in_request*/,
    const ::aidl::android::hardware::neuralnetworks::
        ExecutionConfig& /*in_config*/,
    int64_t /*in_deadlineNs*/,
...
::ndk::ScopedAStatus IPreparedModelDefault::executeFencedWithConfig(
    const ::aidl::android::hardware::neuralnetworks::Request& /*in_request*/,
    const std::vector<::ndk::ScopedFileDescriptor>& /*in_waitFor*/,
    const ::aidl::android::hardware::neuralnetworks::
        ExecutionConfig& /*in_config*/,
...
::ndk::ScopedAStatus IPreparedModelDefault::getInterfaceVersion(
    int32_t* _aidl_return) {
  *_aidl_return = 0;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
::ndk::ScopedAStatus IPreparedModelDefault::getInterfaceHash(
    std::string* _aidl_return) {
  *_aidl_return = "";
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
