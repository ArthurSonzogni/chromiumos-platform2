...
static binder_status_t _aidl_android_hardware_neuralnetworks_IBuffer_onTransact(
  ...
  std::shared_ptr<BnBuffer> _aidl_impl = std::static_pointer_cast<BnBuffer>(
  ...
  switch (_aidl_code) {
    case (FIRST_CALL_TRANSACTION + 0 /*copyFrom*/): {
      ...
      ::ndk::ScopedAStatus _aidl_status =
          _aidl_impl->copyFrom(in_src, in_dimensions);
      _aidl_ret_status =
...
static AIBinder_Class* _g_aidl_android_hardware_neuralnetworks_IBuffer_clazz =
    ::ndk::ICInterface::defineClass(
        IBuffer::descriptor,
        _aidl_android_hardware_neuralnetworks_IBuffer_onTransact);

BpBuffer::BpBuffer(const ::ndk::SpAIBinder& binder) : BpCInterface(binder) {}
BpBuffer::~BpBuffer() {}

::ndk::ScopedAStatus BpBuffer::copyFrom(
    const ::aidl::android::hardware::neuralnetworks::Memory& in_src,
    const std::vector<int32_t>& in_dimensions) {
  ...
  _aidl_ret_status = AIBinder_transact(
      asBinder().get(), (FIRST_CALL_TRANSACTION + 0 /*copyFrom*/),
...
::ndk::ScopedAStatus BpBuffer::copyTo(
...
::ndk::SpAIBinder BnBuffer::createBinder() {
  AIBinder* binder =
      AIBinder_new(_g_aidl_android_hardware_neuralnetworks_IBuffer_clazz,
...
std::shared_ptr<IBuffer> IBuffer::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(
          binder.get(),
          _g_aidl_android_hardware_neuralnetworks_IBuffer_clazz)) {
    return nullptr;
  }
...
binder_status_t IBuffer::writeToParcel(
...
binder_status_t IBuffer::readFromParcel(const AParcel* parcel,
...
::ndk::ScopedAStatus IBufferDefault::copyFrom(
    const ::aidl::android::hardware::neuralnetworks::Memory& /*in_src*/,
    const std::vector<int32_t>& /*in_dimensions*/) {
  ::ndk::ScopedAStatus _aidl_status;
...
::ndk::ScopedAStatus IBufferDefault::copyTo(
    const ::aidl::android::hardware::neuralnetworks::Memory& /*in_dst*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IBufferDefault::getInterfaceVersion(
    int32_t* _aidl_return) {
  *_aidl_return = 0;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
::ndk::ScopedAStatus IBufferDefault::getInterfaceHash(
    std::string* _aidl_return) {
  *_aidl_return = "";
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
