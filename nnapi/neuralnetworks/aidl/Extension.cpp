...
const char* Extension::descriptor = "android.hardware.neuralnetworks.Extension";

binder_status_t Extension::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &operandTypes);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }
...
binder_status_t Extension::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, operandTypes);
  if (_aidl_ret_status != STATUS_OK) {
    return _aidl_ret_status;
  }
