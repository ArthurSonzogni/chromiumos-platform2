...
_aidl_android_hardware_neuralnetworks_IFencedExecutionCallback_onTransact(
  ...
  std::shared_ptr<BnFencedExecutionCallback> _aidl_impl =
      std::static_pointer_cast<BnFencedExecutionCallback>(
  ...
  switch (_aidl_code) {
    case (FIRST_CALL_TRANSACTION + 0 /*getExecutionInfo*/): {
      ...
      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->getExecutionInfo(
          &out_timingLaunched, &out_timingFenced, &_aidl_return);
      _aidl_ret_status =
      ...
      _aidl_ret_status =
          ::ndk::AParcel_writeData(_aidl_out, out_timingLaunched);
      if (_aidl_ret_status != STATUS_OK) {
        break;
      }

      _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_out, out_timingFenced);
      if (_aidl_ret_status != STATUS_OK) {
        break;
      }
...
static AIBinder_Class*
    _g_aidl_android_hardware_neuralnetworks_IFencedExecutionCallback_clazz =
        ::ndk::ICInterface::defineClass(
            IFencedExecutionCallback::descriptor,
            _aidl_android_hardware_neuralnetworks_IFencedExecutionCallback_onTransact);
...
::ndk::ScopedAStatus BpFencedExecutionCallback::getExecutionInfo(
    ::aidl::android::hardware::neuralnetworks::Timing* out_timingLaunched,
    ::aidl::android::hardware::neuralnetworks::Timing* out_timingFenced,
    ::aidl::android::hardware::neuralnetworks::ErrorStatus* _aidl_return) {
  ...
  _aidl_ret_status = AIBinder_transact(
      asBinder().get(), (FIRST_CALL_TRANSACTION + 0 /*getExecutionInfo*/),
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IFencedExecutionCallback::getDefaultImpl()) {
    _aidl_status = IFencedExecutionCallback::getDefaultImpl()->getExecutionInfo(
        out_timingLaunched, out_timingFenced, _aidl_return);
  ...
  _aidl_ret_status =
      ::ndk::AParcel_readData(_aidl_out.get(), out_timingLaunched);
  if (_aidl_ret_status != STATUS_OK) {
    goto _aidl_error;
  }

  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_out.get(), out_timingFenced);
  if (_aidl_ret_status != STATUS_OK) {
    goto _aidl_error;
  }
...
::ndk::ScopedAStatus BpFencedExecutionCallback::getInterfaceVersion(
    int32_t* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IFencedExecutionCallback::getDefaultImpl()) {
    _aidl_status =
        IFencedExecutionCallback::getDefaultImpl()->getInterfaceVersion(
            _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) {
...
::ndk::ScopedAStatus BpFencedExecutionCallback::getInterfaceHash(
    std::string* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
      IFencedExecutionCallback::getDefaultImpl()) {
    _aidl_status = IFencedExecutionCallback::getDefaultImpl()->getInterfaceHash(
        _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) {
...
::ndk::ScopedAStatus BnFencedExecutionCallback::getInterfaceVersion(
    int32_t* _aidl_return) {
  *_aidl_return = IFencedExecutionCallback::version;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
::ndk::ScopedAStatus BnFencedExecutionCallback::getInterfaceHash(
    std::string* _aidl_return) {
...
const char* IFencedExecutionCallback::descriptor =
    "android.hardware.neuralnetworks.IFencedExecutionCallback";
IFencedExecutionCallback::IFencedExecutionCallback() {}
IFencedExecutionCallback::~IFencedExecutionCallback() {}

std::shared_ptr<IFencedExecutionCallback> IFencedExecutionCallback::fromBinder(
    const ::ndk::SpAIBinder& binder) {
...
binder_status_t IFencedExecutionCallback::writeToParcel(
    AParcel* parcel,
...
binder_status_t IFencedExecutionCallback::readFromParcel(
...
bool IFencedExecutionCallback::setDefaultImpl(
...
const std::shared_ptr<IFencedExecutionCallback>&
IFencedExecutionCallback::getDefaultImpl() {
  return IFencedExecutionCallback::default_impl;
}
std::shared_ptr<IFencedExecutionCallback>
    IFencedExecutionCallback::default_impl = nullptr;
::ndk::ScopedAStatus IFencedExecutionCallbackDefault::getExecutionInfo(
    ::aidl::android::hardware::neuralnetworks::Timing* /*out_timingLaunched*/,
    ::aidl::android::hardware::neuralnetworks::Timing* /*out_timingFenced*/,
    ::aidl::android::hardware::neuralnetworks::ErrorStatus* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
...
::ndk::ScopedAStatus IFencedExecutionCallbackDefault::getInterfaceVersion(
    int32_t* _aidl_return) {
  *_aidl_return = 0;
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
::ndk::ScopedAStatus IFencedExecutionCallbackDefault::getInterfaceHash(
    std::string* _aidl_return) {
  *_aidl_return = "";
  return ::ndk::ScopedAStatus(AStatus_newOk());
}
