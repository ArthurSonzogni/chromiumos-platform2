...
#ifndef MISSIVE_CLIENT_MOCK_REPORT_QUEUE_PROVIDER_H_
#define MISSIVE_CLIENT_MOCK_REPORT_QUEUE_PROVIDER_H_
...
#endif  // MISSIVE_CLIENT_MOCK_REPORT_QUEUE_PROVIDER_H_
