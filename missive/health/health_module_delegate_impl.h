...
#ifndef MISSIVE_HEALTH_HEALTH_MODULE_DELEGATE_IMPL_H_
#define MISSIVE_HEALTH_HEALTH_MODULE_DELEGATE_IMPL_H_
...
#endif  // MISSIVE_HEALTH_HEALTH_MODULE_DELEGATE_IMPL_H_
