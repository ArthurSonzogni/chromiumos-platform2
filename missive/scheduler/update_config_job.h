...
#ifndef MISSIVE_SCHEDULER_UPDATE_CONFIG_JOB_H_
#define MISSIVE_SCHEDULER_UPDATE_CONFIG_JOB_H_
...
class UpdateConfigInMissiveJob : public Scheduler::Job {
 public:
  class UpdateConfigInMissiveResponseDelegate : public Job::JobDelegate {
   public:
    explicit UpdateConfigInMissiveResponseDelegate(
  ...
  UpdateConfigInMissiveJob(const UpdateConfigInMissiveJob& other) = delete;
  UpdateConfigInMissiveJob& operator=(const UpdateConfigInMissiveJob& other) =
      delete;

  static SmartPtr<UpdateConfigInMissiveJob> Create(
 ...
 protected:
  // UpdateConfigInMissiveJob::StartImpl expects UpdateConfigInMissiveRequest to
 ...
 private:
  ...
  const UpdateConfigInMissiveRequest request_;
  base::WeakPtrFactory<UpdateConfigInMissiveJob> weak_ptr_factory_{this};
};

}  // namespace reporting

#endif  // MISSIVE_SCHEDULER_UPDATE_CONFIG_JOB_H_
