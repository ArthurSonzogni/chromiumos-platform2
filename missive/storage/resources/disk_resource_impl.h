...
#ifndef MISSIVE_STORAGE_RESOURCES_DISK_RESOURCE_IMPL_H_
#define MISSIVE_STORAGE_RESOURCES_DISK_RESOURCE_IMPL_H_
...
#endif  // MISSIVE_STORAGE_RESOURCES_DISK_RESOURCE_IMPL_H_
