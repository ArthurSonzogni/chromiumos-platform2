...
#ifndef MISSIVE_ENCRYPTION_PRIMITIVES_H_
#define MISSIVE_ENCRYPTION_PRIMITIVES_H_
...
static constexpr size_t kSignKeySize = 32u;
...
#endif  // MISSIVE_ENCRYPTION_PRIMITIVES_H_
