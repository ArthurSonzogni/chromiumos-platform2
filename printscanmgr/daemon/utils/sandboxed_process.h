...
#ifndef PRINTSCANMGR_DAEMON_UTILS_SANDBOXED_PROCESS_H_
#define PRINTSCANMGR_DAEMON_UTILS_SANDBOXED_PROCESS_H_
...
#endif  // PRINTSCANMGR_DAEMON_UTILS_SANDBOXED_PROCESS_H_
