...
#ifndef PRINTSCANMGR_DAEMON_UTILS_PROCESS_WITH_OUTPUT_H_
#define PRINTSCANMGR_DAEMON_UTILS_PROCESS_WITH_OUTPUT_H_
...
#endif  // PRINTSCANMGR_DAEMON_UTILS_PROCESS_WITH_OUTPUT_H_
