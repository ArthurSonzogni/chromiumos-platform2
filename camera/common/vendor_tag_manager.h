...
const uint32_t kCrosDigitalZoomVendorTagStart = 0x80070000;
const uint32_t kCrosDigitalZoomVendorTagEnd = 0x80080000;

const uint32_t kLibcameraVendorTagStart = 0x80080000;
const uint32_t kLibcameraVendorTagEnd = 0x80090000;
...
const uint32_t kNextAvailableVendorTag = kLibcameraVendorTagEnd;
