...
const std::map<flex_bluetooth::BluetoothAdapter,
    ...
    kAdapterSyspropOverrides = {
        ...
        // Disable packet boundary & sniff mode opcode for Qualcomm Atheros
        // AR9462 / AR3012 / AR9565 chips.
        {flex_bluetooth::BluetoothAdapter{0x04ca, 0x3006},
         {flex_bluetooth::SyspropOverride::kDisablePacketBoundary,
          flex_bluetooth::SyspropOverride::kDisableSniffMode}},
        {flex_bluetooth::BluetoothAdapter{0x0cf3, 0x0036},
         {flex_bluetooth::SyspropOverride::kDisablePacketBoundary,
          flex_bluetooth::SyspropOverride::kDisableSniffMode}},
        ...
        {flex_bluetooth::BluetoothAdapter{0x04c5, 0x1330},
         {flex_bluetooth::SyspropOverride::kDisablePacketBoundary,
          flex_bluetooth::SyspropOverride::kDisableSniffMode}},
        {flex_bluetooth::BluetoothAdapter{0x0930, 0x0227},
         {flex_bluetooth::SyspropOverride::kDisablePacketBoundary,
          flex_bluetooth::SyspropOverride::kDisableSniffMode}},
        {flex_bluetooth::BluetoothAdapter{0x0cf3, 0x311f},
         {flex_bluetooth::SyspropOverride::kDisablePacketBoundary,
          flex_bluetooth::SyspropOverride::kDisableSniffMode}},
        {flex_bluetooth::BluetoothAdapter{0x0cf3, 0xe005},
         {flex_bluetooth::SyspropOverride::kDisablePacketBoundary,
          flex_bluetooth::SyspropOverride::kDisableSniffMode}},
