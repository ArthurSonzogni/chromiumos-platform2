...
enum TimerType {
  ...
  kAuthSessionRemoveAuthFactorUSSTimer = 6,
  kCreatePersistentUserTimer = 7,
  kAuthSessionTotalLifetimeTimer = 8,
  kAuthSessionAuthenticatedLifetimeTimer = 9,
  kUSSPersistTimer = 10,
  kUSSLoadPersistedTimer = 11,
  kUSSMigrationTimer = 12,
  kVaultSetupTimer = 13,
  kSELinuxRelabelTimer = 14,
  kStoreUserPolicyTimer = 15,
  kLoadUserPolicyTimer = 16,
  kAuthSessionReplaceAuthFactorTimer = 17,
