...
bool DoRecoveryCryptoCreateAction(
  ...
  SecureBlob mediator_share, destination_share, dealer_pub_key;
  if (!recovery_crypto->GenerateShares(&mediator_share, &destination_share,
                                       &dealer_pub_key)) {
  ...
  return WriteFileLogged(destination_share_out_file_path, destination_share) &&
         WriteFileLogged(mediator_share_out_file_path, mediator_share) &&
...
bool DoRecoveryCryptoMediateAction(
  ...
  SecureBlob mediator_share, publisher_pub_key;
  ...
  if (!recovery_crypto->Mediate(publisher_pub_key, mediator_share,
