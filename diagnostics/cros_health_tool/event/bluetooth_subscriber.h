...
#ifndef DIAGNOSTICS_CROS_HEALTH_TOOL_EVENT_BLUETOOTH_SUBSCRIBER_H_
#define DIAGNOSTICS_CROS_HEALTH_TOOL_EVENT_BLUETOOTH_SUBSCRIBER_H_
...
#endif  // DIAGNOSTICS_CROS_HEALTH_TOOL_EVENT_BLUETOOTH_SUBSCRIBER_H_
