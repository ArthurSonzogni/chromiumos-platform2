...
#ifndef DIAGNOSTICS_CROS_HEALTHD_DELEGATE_EVENTS_STYLUS_GARAGE_EVDEV_DELEGATE_H_
#define DIAGNOSTICS_CROS_HEALTHD_DELEGATE_EVENTS_STYLUS_GARAGE_EVDEV_DELEGATE_H_
...
class StylusGarageEvdevDelegate final : public EvdevMonitor::Delegate {
 public:
...
#endif  // DIAGNOSTICS_CROS_HEALTHD_DELEGATE_EVENTS_STYLUS_GARAGE_EVDEV_DELEGATE_H_
