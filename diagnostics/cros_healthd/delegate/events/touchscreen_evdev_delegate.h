...
#ifndef DIAGNOSTICS_CROS_HEALTHD_DELEGATE_EVENTS_TOUCHSCREEN_EVDEV_DELEGATE_H_
#define DIAGNOSTICS_CROS_HEALTHD_DELEGATE_EVENTS_TOUCHSCREEN_EVDEV_DELEGATE_H_
...
class TouchscreenEvdevDelegate final : public EvdevMonitor::Delegate {
 public:
...
#endif  // DIAGNOSTICS_CROS_HEALTHD_DELEGATE_EVENTS_TOUCHSCREEN_EVDEV_DELEGATE_H_
