...
#ifndef DIAGNOSTICS_CROS_HEALTHD_DELEGATE_EVENTS_POWER_BUTTON_EVDEV_DELEGATE_H_
#define DIAGNOSTICS_CROS_HEALTHD_DELEGATE_EVENTS_POWER_BUTTON_EVDEV_DELEGATE_H_
...
class PowerButtonEvdevDelegate final : public EvdevMonitor::Delegate {
 public:
...
#endif  // DIAGNOSTICS_CROS_HEALTHD_DELEGATE_EVENTS_POWER_BUTTON_EVDEV_DELEGATE_H_
