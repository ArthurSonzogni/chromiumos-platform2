...
inline constexpr auto kEcDriverSysfsPath =
    "sys/bus/platform/devices/GOOG000C:00/";

// Folder path to EC properties exposed by sysfs EC driver. Relative path to
// |kEcDriverSysfsPath|.
inline constexpr auto kEcDriverSysfsPropertiesPath = "properties/";

// Max request and response payload size for EC telemetry command.
inline constexpr int64_t kEcGetTelemetryPayloadMaxSize = 32;

// Devfs node exposed by EC driver to EC telemetry data.
inline constexpr auto kEcGetTelemetryFilePath = "dev/wilco_telem0";

// EC event file path.
inline constexpr auto kEcEventFilePath = "dev/wilco_event0";
