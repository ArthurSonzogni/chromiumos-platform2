...
#ifndef DIAGNOSTICS_CROS_HEALTHD_FETCHERS_STORAGE_EMMC_DEVICE_ADAPTER_H_
#define DIAGNOSTICS_CROS_HEALTHD_FETCHERS_STORAGE_EMMC_DEVICE_ADAPTER_H_
...
#endif  // DIAGNOSTICS_CROS_HEALTHD_FETCHERS_STORAGE_EMMC_DEVICE_ADAPTER_H_
