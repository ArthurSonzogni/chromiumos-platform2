...
#ifndef DIAGNOSTICS_CROS_HEALTHD_ROUTINES_FAKE_CROS_HEALTHD_ROUTINE_FACTORY_H_
#define DIAGNOSTICS_CROS_HEALTHD_ROUTINES_FAKE_CROS_HEALTHD_ROUTINE_FACTORY_H_
...
#endif  // DIAGNOSTICS_CROS_HEALTHD_ROUTINES_FAKE_CROS_HEALTHD_ROUTINE_FACTORY_H_
