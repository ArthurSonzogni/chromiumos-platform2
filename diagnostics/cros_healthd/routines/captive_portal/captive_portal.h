...
#ifndef DIAGNOSTICS_CROS_HEALTHD_ROUTINES_CAPTIVE_PORTAL_CAPTIVE_PORTAL_H_
#define DIAGNOSTICS_CROS_HEALTHD_ROUTINES_CAPTIVE_PORTAL_CAPTIVE_PORTAL_H_
...
#endif  // DIAGNOSTICS_CROS_HEALTHD_ROUTINES_CAPTIVE_PORTAL_CAPTIVE_PORTAL_H_
