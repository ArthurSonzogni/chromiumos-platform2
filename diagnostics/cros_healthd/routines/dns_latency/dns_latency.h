...
#ifndef DIAGNOSTICS_CROS_HEALTHD_ROUTINES_DNS_LATENCY_DNS_LATENCY_H_
#define DIAGNOSTICS_CROS_HEALTHD_ROUTINES_DNS_LATENCY_DNS_LATENCY_H_
...
#endif  // DIAGNOSTICS_CROS_HEALTHD_ROUTINES_DNS_LATENCY_DNS_LATENCY_H_
