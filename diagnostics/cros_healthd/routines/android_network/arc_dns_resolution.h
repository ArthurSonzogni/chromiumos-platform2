...
#ifndef DIAGNOSTICS_CROS_HEALTHD_ROUTINES_ANDROID_NETWORK_ARC_DNS_RESOLUTION_H_
#define DIAGNOSTICS_CROS_HEALTHD_ROUTINES_ANDROID_NETWORK_ARC_DNS_RESOLUTION_H_
...
#endif  // DIAGNOSTICS_CROS_HEALTHD_ROUTINES_ANDROID_NETWORK_ARC_DNS_RESOLUTION_H_
