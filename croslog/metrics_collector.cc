...
const char kSystemArcLogFileSizePerDay[] = "Logging.SystemArcLogFileSizePerDay";
const char kSystemAuditLogFileSizePerDay[] =
    "Logging.SystemAuditLogFileSizePerDay";
const char kSystemChromeLogFileSizePerDay[] =
    "Logging.SystemChromeLogFileSizePerDay";
const char kSystemMessageLogFileSizePerDay[] =
    "Logging.SystemMessageLogFileSizePerDay";
const char kSystemNetLogFileSizePerDay[] = "Logging.SystemNetLogFileSizePerDay";
const char kUserChromeLogFileSizePerDay[] =
    "Logging.UserChromeLogFileSizePerDay";

const char kSystemLogTotalSize[] = "Logging.SystemLogTotalFileSize";
const char kUserLogTotalSize[] = "Logging.UserLogTotalFileSize";

const char kSystemLogTotalEntryCountPerDay[] =
    "Logging.SystemLogEntryCountPerDay";
const char kUserLogTotalEntryCountPerDay[] = "Logging.UserLogEntryCountPerDay";

const char kSystemLogMaximumThroughput[] =
    "Logging.SystemLogMaxThroughputPerMin";
const char kUserLogMaximumThroughput[] = "Logging.UserLogMaxThroughputPerMin";
